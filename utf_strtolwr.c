// gcc -g -O0 utf_strtolwr.c && ./a.out АаБбВвГгДдЕеЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя ЂђЃѓ ѓЃ Љљ ЊњЌќЋћЏџђЂ љЉ њЊќЌћЋџЏ ЎўўЎЈј Ґґ Ёё Єє Її ІііІґҐ ёЁ єЄ јЈЅѕѕЅїЇ
// from https://stackoverflow.com/a/53920363 as of 2024-12-14
...
unsigned char* StrToLwrExt(unsigned char* pString)
{
    ...
    for (unsigned char* p = pString; *p; p++) {
